...
class ScheduleEntry extends Eloquent {
	 ...
	 * @var array
	 */
	protected $fillable = array('schdl_id', 
								'jbtyp_id',
								'prsn_id',
								'entry_user_comment',
								'entry_time_start',
	...
	public function getJobType() {
        return $this->belongsTo('Jobtype', 'jbtyp_id', 'id');
    }
	...
	public function getPerson() {
        return $this->belongsTo('Person', 'prsn_id', 'id');
    }
	...
	public function getSchedule() {
        return $this->belongsTo('Schedule', 'schdl_id', 'id');
    }
