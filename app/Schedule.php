...
class Schedule extends Model
{
     ...
     * Looks up in table club_events for that entry, which has the same id like club_event_id of Schedule instance.
    ...
    {
        return $this->belongsTo('Lara\ClubEvent', 'club_event_id', 'id');
    }
