...
<div class="panel panel-primary">
    ...
    <div class="panel-body no-padding">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#german" data-toggle="tab" aria-expanded="true">Deutsche Version</a></li>
            <li class=""><a href="#english" data-toggle="tab" aria-expanded="false">English Version</a></li>
        </ul>
