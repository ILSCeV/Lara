    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <h1><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Lara Log Viewer</h1>
          ...
          <table id="table-log" class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text">
                  @if ($log['stack']) <a class="float-right expand btn btn-secondary btn-xs" data-display="stack{{$key}}"><span class="glyphicon glyphicon-search"></span></a>@endif
                  {{$log['text']}}
