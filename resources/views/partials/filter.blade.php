<div id="section-filter" class="hidden-print">
	...
	@foreach($sections as $section)
		<span id="label-{!! $section["title"] !!}" class="label label-filters palette-{{$section->color}}-500-Primary bg">
            {!! $section["title"] !!}
            &nbsp;
            <span class="glyphicon glyphicon-remove-circle"></span>
        </span>
	@endforeach
	<span id="label-survey" class="label label-filters palette-Purple-900-Primary bg">{{trans('mainLang.survey')}}
        &nbsp;
        <span class="glyphicon glyphicon-remove-circle"></span>
     </span>
