        ...
        <div class="containerPadding15Mobile">
            <div class="panel panel-warning">
                ...
                <div class="panel panel-body">
                    @if ($creator_name == "")
                        <h6>Nur die <b>Clubleitung</b> oder die <b>Marketingverantwortlichen</b> dürfen diese
                            Veranstaltung/Aufgabe ändern.</h6>
                    @else
                        <h6>Nur <b>{!! $creator_name !!}</b>, die <b>Clubleitung</b> oder die
                            <b>Marketingverantwortlichen</b> dürfen diese Veranstaltung/Aufgabe ändern.</h6>
                    @endif
                </div>
            </div>
        </div>
