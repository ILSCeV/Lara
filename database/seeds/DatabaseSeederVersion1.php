...
class DatabaseSeederVersion1 extends Seeder {

	/**
	 * Run the original set of lara-vedst database seeds, handcrafted by the swp group.
	 * Each table gets its own method.
	 * Tables will be cleared and filled with example entries.
	 *
	 * Seeding: 'php artisan migrate:refresh && composer dumpautoload && php artisan db:seed --class=DatabaseSeederVersion1'
	 *
	 * @return void
	 */
	public function run() {
		...
		$this->call('ClubEventsTableSeederV1');
		$this->call('SchedulesTableSeederV1');
		$this->call('PersonsTableSeederV1');
		$this->call('JobtypesTableSeederV1');
		$this->call('PlacesTableSeederV1');
		$this->call('ClubsTableSeederV1');
		$this->call('ScheduleEntriesTableSeederV1');
	}
}

class ClubEventsTableSeederV1 extends Seeder {
...
class SchedulesTableSeederV1 extends Seeder {
...
class PersonsTableSeederV1 extends Seeder {
...
class JobtypesTableSeederV1 extends Seeder {
...
class PlacesTableSeederV1 extends Seeder {
...
class ClubsTableSeederV1 extends Seeder {
...
class ScheduleEntriesTableSeederV1 extends Seeder {
